        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          {printfulManaged ? (
            <div className="flex gap-3 rounded-lg border border-amber-500 bg-amber-50 p-4 text-sm text-amber-950 dark:bg-amber-950 dark:text-amber-100">
              ...
              <p>
                Printful sync overwrites this product’s name, slug, description,
                price, images, variants, and active status. Edit those fields in
                Printful. Featured status and non-empty categories and tags are
                preserved.
              </p>
            </div>
          ) : null}
